...
class VideoFixtures extends Fixture implements DependentFixtureInterface
{
    public const VIDEO_JS_LESSON_DATA = [
        ...
        [   'video' => 'jslesson.mp4',
            ...
            'description' => 'Découvre comment écrire des opérateurs conditionnels pour prendre des décisions dans ton code Javascript',
            'category' => Video::CATEGORY_LESSON,
        ],
        [   'video' => 'jslesson.mp4',
            'title' => 'Les boucles',
            'thumbnail' => 'bouclesjs.jpg',
            'description' => 'Découvre comment écrire des boucles pour pouvoir itérer dans ton code Javascript',
            'category' => Video::CATEGORY_LESSON,
        ],
        [   'video' => 'jslesson.mp4',
            'title' => 'Les fonctions',
        ...
        [   'video' => 'jslesson.mp4',
            ...
            'description' => 'Découvre comment renvoyer une erreur quand ta fonction reçoit un paramètre qui ne convient pas en JavaScript',
            'category' => Video::CATEGORY_LESSON,
        ],
        [   'video' => 'jslesson.mp4',
            'title' => 'Les promises',
        ...
        [   'video' => 'jslesson.mp4',
            ...
            'description' => 'Découvre comment faire des appels HTTP afin de récupérer des ressources sur le réseau et utilise le système de promise en JavaScript',
            'category' => Video::CATEGORY_LESSON,
        ],
        [   'video' => 'jslesson.mp4',
            'title' => 'Les modules',
            'thumbnail' => 'modulesjs.jpg',
            'description' => 'Découvre comment morceler le code en plusieurs fichiers afin de mieux l\'organiser en JavaScript',
            'category' => Video::CATEGORY_LESSON,
        ],
        [   'video' => 'jslesson.mp4',
            'title' => 'L\'objet Date',
            'thumbnail' => 'datejs.jpg',
            'description' => 'Découvre comment utiliser l\'objet Date pour représenter une date en JavaScript',
            'category' => Video::CATEGORY_LESSON,
        ],
        [   'video' => 'jslesson.mp4',
            'title' => 'Les écouteurs d\'événements',
            'thumbnail' => 'ecouteursjs.jpg',
            'description' => 'Découvre comment déclencher un script lors d\'un événement particulier en JavaScript',
            'category' => Video::CATEGORY_LESSON,
        ],
    ];
    public const VIDEO_JS_TUTORIEL_DATA = [
        ...
        [   'video' => 'jstutoriel.mp4',
            ...
            'description' => 'Apprends à créer un espace de commentaires qui charge de nouveaux commentaires lorsqu\'on scroll la page !',
            'category' => Video::CATEGORY_TUTORIEL,
        ],
        [   'video' => 'jstutoriel.mp4',
    ...
    public const VIDEO_JS_LIVECODING_DATA = [
        [   'video' => 'jslivecoding.mp4',
            ...
            'description' => 'Regarde comment créer une app Node.js à partir de rien. Mise en place des fichiers du site.',
            'category' => Video::CATEGORY_LIVECODING,
        ],
        [   'video' => 'jslivecoding.mp4',
            'title' => 'Coder une app Node.js en tant que débutant (2/6)',
            'thumbnail' => 'livecodingjs1.jpg',
            'description' => 'Regarde comment créer une app Node.js à partir de rien. Mise en place des routes et chargement d\'une API.',
            'category' => Video::CATEGORY_LIVECODING,
        ],
        [   'video' => 'jslivecoding.mp4',
            'title' => 'Coder une app Node.js en tant que débutant (3/6)',
            'thumbnail' => 'livecodingjs1.jpg',
            'description' => 'Regarde comment créer une app Node.js à partir de rien. Utilisation de l\'asynchrone pour récupérer un JSON.',
            'category' => Video::CATEGORY_LIVECODING,
        ],
        [   'video' => 'jslivecoding.mp4',
            'title' => 'Coder une app Node.js en tant que débutant (4/6)',
            'thumbnail' => 'livecodingjs1.jpg',
            'description' => 'Regarde comment créer une app Node.js à partir de rien. Génération dynamique d\'un tag d\'image.',
            'category' => Video::CATEGORY_LIVECODING,
        ],
        [   'video' => 'jslivecoding.mp4',
            'title' => 'Coder une app Node.js en tant que débutant (5/6)',
            'thumbnail' => 'livecodingjs1.jpg',
            'description' => 'Regarde comment créer une app Node.js à partir de rien. Sécuriser la clé API.',
            'category' => Video::CATEGORY_LIVECODING,
        ],
        [   'video' => 'jslivecoding.mp4',
            'title' => 'Coder une app Node.js en tant que débutant (6/6)',
            'thumbnail' => 'livecodingjs1.jpg',
            'description' => 'Regarde comment créer une app Node.js à partir de rien. Styliser et dynamiser le site.',
            'category' => Video::CATEGORY_LIVECODING,
        ],
        [   'video' => 'jslivecoding.mp4',
            'title' => 'Coder une app de sondage en JavaScript (1/15)',
            'thumbnail' => 'livecodingjs2.jpg',
            'description' => 'Regarde comment créer une app JavaScript avec Alex et Chris. Initialisation Git et NPM.',
            'category' => Video::CATEGORY_LIVECODING,
        ],
        [   'video' => 'jslivecoding.mp4',
            'title' => 'Coder une app de sondage en JavaScript (2/15)',
            'thumbnail' => 'livecodingjs2.jpg',
            'description' => 'Regarde comment créer une app JavaScript avec Alex et Chris. Mise en place des outils d\'environnement de code.',
            'category' => Video::CATEGORY_LIVECODING,
        ],
        [   'video' => 'jslivecoding.mp4',
            'title' => 'Coder une app de sondage en JavaScript (3/15)',
            'thumbnail' => 'livecodingjs2.jpg',
            'description' => 'Regarde comment créer une app JavaScript avec Alex et Chris. Mise en place de la base de données. Création des tables et des relations.',
            'category' => Video::CATEGORY_LIVECODING,
        ],
        [   'video' => 'jslivecoding.mp4',
            'title' => 'Coder une app de sondage en JavaScript (4/15)',
            'thumbnail' => 'livecodingjs2.jpg',
            'description' => 'Regarde comment créer une app JavaScript avec Alex et Chris. Création du controlleur des sondages.',
            'category' => Video::CATEGORY_LIVECODING,
        ],
        [   'video' => 'jslivecoding.mp4',
            'title' => 'Coder une app de sondage en JavaScript (5/15)',
            'thumbnail' => 'livecodingjs2.jpg',
            'description' => 'Regarde comment créer une app JavaScript avec Alex et Chris. Gestion des requêtes.',
            'category' => Video::CATEGORY_LIVECODING,
        ],
        [   'video' => 'jslivecoding.mp4',
            'title' => 'Coder une app de sondage en JavaScript (6/15)',
            'thumbnail' => 'livecodingjs2.jpg',
            'description' => 'Regarde comment créer une app JavaScript avec Alex et Chris. Création du controlleur des votes.',
            'category' => Video::CATEGORY_LIVECODING,
        ],
        [   'video' => 'jslivecoding.mp4',
            'title' => 'Coder une app de sondage en JavaScript (7/15)',
            'thumbnail' => 'livecodingjs2.jpg',
            'description' => 'Regarde comment créer une app JavaScript avec Alex et Chris. Création du modèle des votes.',
            'category' => Video::CATEGORY_LIVECODING,
        ],
        [   'video' => 'jslivecoding.mp4',
            'title' => 'Coder une app de sondage en JavaScript (8/15)',
            'thumbnail' => 'livecodingjs2.jpg',
            'description' => 'Regarde comment créer une app JavaScript avec Alex et Chris. Mise en relation des sondages et des votes.',
            'category' => Video::CATEGORY_LIVECODING,
        ],
        [   'video' => 'jslivecoding.mp4',
            'title' => 'Coder une app de sondage en JavaScript (9/15)',
            'thumbnail' => 'livecodingjs2.jpg',
            'description' => 'Regarde comment créer une app JavaScript avec Alex et Chris. Débogage et optimisation du code.',
            'category' => Video::CATEGORY_LIVECODING,
        ],
        [   'video' => 'jslivecoding.mp4',
            'title' => 'Coder une app de sondage en JavaScript (10/15)',
            'thumbnail' => 'livecodingjs2.jpg',
            'description' => 'Regarde comment créer une app JavaScript avec Alex et Chris. Gestion des erreurs.',
            'category' => Video::CATEGORY_LIVECODING,
        ],
        [   'video' => 'jslivecoding.mp4',
            'title' => 'Coder une app de sondage en JavaScript (11/15)',
            'thumbnail' => 'livecodingjs2.jpg',
            'description' => 'Regarde comment créer une app JavaScript avec Alex et Chris. Sécurisation et validation.',
            'category' => Video::CATEGORY_LIVECODING,
        ],
        [   'video' => 'jslivecoding.mp4',
            'title' => 'Coder une app de sondage en JavaScript (12/15)',
            'thumbnail' => 'livecodingjs2.jpg',
            'description' => 'Regarde comment créer une app JavaScript avec Alex et Chris. Mise en place de Webpack.',
            'category' => Video::CATEGORY_LIVECODING,
        ],
        [   'video' => 'jslivecoding.mp4',
            'title' => 'Coder une app de sondage en JavaScript (13/15)',
            'thumbnail' => 'livecodingjs2.jpg',
            'description' => 'Regarde comment créer une app JavaScript avec Alex et Chris. Création des composants Resultat et Vote.',
            'category' => Video::CATEGORY_LIVECODING,
        ],
        [   'video' => 'jslivecoding.mp4',
            'title' => 'Coder une app de sondage en JavaScript (14/15)',
            'thumbnail' => 'livecodingjs2.jpg',
            'description' => 'Regarde comment créer une app JavaScript avec Alex et Chris. Styliser et dynamiser.',
            'category' => Video::CATEGORY_LIVECODING,
        ],
        [   'video' => 'jslivecoding.mp4',
            'title' => 'Coder une app de sondage en JavaScript (15/15)',
            'thumbnail' => 'livecodingjs2.jpg',
            'description' => 'Regarde comment créer une app JavaScript avec Alex et Chris. Télécharger le code sur GitHub.',
            'category' => Video::CATEGORY_LIVECODING,
        ],
    ];
    ...
    public const VIDEO_PHP_LESSON_DATA = [
        [   'video' => 'phplesson.mp4',
            ...
            'description' => 'Les différentes méthodes d\'installation de PHP en fonction de ton système d\'exploitation',
            'category' => Video::CATEGORY_LESSON,
        ],
        [   'video' => 'phplesson.mp4',
            'title' => 'Les variables',
        ...
        [   'video' => 'phplesson.mp4',
            ...
            'description' => 'Découvre comment écrire des opérateurs conditionnels pour prendre des décisions dans ton code PHP',
            'category' => Video::CATEGORY_LESSON,
        ],
        [   'video' => 'phplesson.mp4',
            'title' => 'Les boucles',
        ...
        [   'video' => 'phplesson.mp4',
            ...
            'description' => 'Découvre comment construire une requête personnalisée en PHP grâce au Query Builder',
            'category' => Video::CATEGORY_LESSON,
        ],
        [   'video' => 'phplesson.mp4',
            'title' => 'La pagination',
    ...
    public const VIDEO_PHP_TUTORIEL_DATA = [
        ...
        [   'video' => 'phptutoriel.mp4',
            ...
            'description' => 'Découvre comment mettre en place un dashboard administrateur sur ton site en PHP',
            'category' => Video::CATEGORY_TUTORIEL,
        ],
        [   'video' => 'phptutoriel.mp4',
            'title' => 'Mettre en place un système de connexion',
            'thumbnail' => 'authphp.jpg',
            'description' => 'Découvre comment mettre en place un système de connexion sur ton site en PHP',
            'category' => Video::CATEGORY_TUTORIEL,
        ],
        [   'video' => 'phptutoriel.mp4',
    ...
    public const VIDEO_PHP_LIVECODING_DATA = [
        [   'video' => 'phplivecoding.mp4',
            ...
            'description' => 'Découvre comment créer un site de A à Z en PHP : installation et configuration du projet',
            'category' => Video::CATEGORY_LIVECODING,
        ],
        [   'video' => 'phplivecoding.mp4',
            'title' => 'Développer un site de recettes en PHP avec Symfony (2/19)',
            'thumbnail' => 'livecodingphp2.jpg',
            'description' => 'Découvre comment créer un site de A à Z en PHP : controller, routing et twig',
            'category' => Video::CATEGORY_LIVECODING,
        ],
        [   'video' => 'phplivecoding.mp4',
            'title' => 'Développer un site de recettes en PHP avec Symfony (3/19)',
            'thumbnail' => 'livecodingphp3.jpg',
            'description' => 'Découvre comment créer un site de A à Z en PHP : première page avec twig',
            'category' => Video::CATEGORY_LIVECODING,
        ],
        [   'video' => 'phplivecoding.mp4',
            'title' => 'Développer un site de recettes en PHP avec Symfony (4/19)',
            'thumbnail' => 'livecodingphp4.jpg',
            'description' => 'Découvre comment créer un site de A à Z en PHP : première entité, présentation de l\'ORM Doctrine',
            'category' => Video::CATEGORY_LIVECODING,
        ],
        [   'video' => 'phplivecoding.mp4',
            'title' => 'Développer un site de recettes en PHP avec Symfony (5/19)',
            'thumbnail' => 'livecodingphp5.jpg',
            'description' => 'Découvre comment créer un site de A à Z en PHP : validation des données',
            'category' => Video::CATEGORY_LIVECODING,
        ],
        [   'video' => 'phplivecoding.mp4',
            'title' => 'Développer un site de recettes en PHP avec Symfony (6/19)',
            'thumbnail' => 'livecodingphp6.jpg',
            'description' => 'Découvre comment créer un site de A à Z en PHP : créer des fixtures',
            'category' => Video::CATEGORY_LIVECODING,
        ],
        [   'video' => 'phplivecoding.mp4',
            'title' => 'Développer un site de recettes en PHP avec Symfony (7/19)',
            'thumbnail' => 'livecodingphp7.jpg',
            'description' => 'Découvre comment créer un site de A à Z en PHP : faire un CRUD (create, read, update, delete)',
            'category' => Video::CATEGORY_LIVECODING,
        ],
        [   'video' => 'phplivecoding.mp4',
            'title' => 'Développer un site de recettes en PHP avec Symfony (8/19)',
            'thumbnail' => 'livecodingphp8.jpg',
            'description' => 'Découvre comment créer un site de A à Z en PHP : sécurité, user et hachage de mot de passe',
            'category' => Video::CATEGORY_LIVECODING,
        ],
        [   'video' => 'phplivecoding.mp4',
            'title' => 'Développer un site de recettes en PHP avec Symfony (9/19)',
            'thumbnail' => 'livecodingphp9.jpg',
            'description' => 'Découvre comment créer un site de A à Z en PHP : créer un formulaire d\'inscription',
            'category' => Video::CATEGORY_LIVECODING,
        ],
        [   'video' => 'phplivecoding.mp4',
            'title' => 'Développer un site de recettes en PHP avec Symfony (10/19)',
            'thumbnail' => 'livecodingphp10.jpg',
            'description' => 'Découvre comment créer un site de A à Z en PHP : relations et query builder',
            'category' => Video::CATEGORY_LIVECODING,
        ],
        [   'video' => 'phplivecoding.mp4',
            'title' => 'Développer un site de recettes en PHP avec Symfony (11/19)',
            'thumbnail' => 'livecodingphp11.jpg',
            'description' => 'Découvre comment créer un site de A à Z en PHP : l\'accès au routes avec is_granted()',
            'category' => Video::CATEGORY_LIVECODING,
        ],
        [   'video' => 'phplivecoding.mp4',
            'title' => 'Développer un site de recettes en PHP avec Symfony (12/19)',
            'thumbnail' => 'livecodingphp12.jpg',
            'description' => 'Découvre comment créer un site de A à Z en PHP : l\'upload d\'images avec VichUploader',
            'category' => Video::CATEGORY_LIVECODING,
        ],
        [   'video' => 'phplivecoding.mp4',
            'title' => 'Développer un site de recettes en PHP avec Symfony (13/19)',
            'thumbnail' => 'livecodingphp13.jpg',
            'description' => 'Découvre comment créer un site de A à Z en PHP : refactorisation',
            'category' => Video::CATEGORY_LIVECODING,
        ],
        [   'video' => 'phplivecoding.mp4',
            'title' => 'Développer un site de recettes en PHP avec Symfony (14/19)',
            'thumbnail' => 'livecodingphp14.jpg',
            'description' => 'Découvre comment créer un site de A à Z en PHP : créer un formulaire de contact',
            'category' => Video::CATEGORY_LIVECODING,
        ],
        [   'video' => 'phplivecoding.mp4',
            'title' => 'Développer un site de recettes en PHP avec Symfony (15/19)',
            'thumbnail' => 'livecodingphp15.jpg',
            'description' => 'Découvre comment créer un site de A à Z en PHP : envoyer des emails',
            'category' => Video::CATEGORY_LIVECODING,
        ],
        [   'video' => 'phplivecoding.mp4',
            'title' => 'Développer un site de recettes en PHP avec Symfony (16/19)',
            'thumbnail' => 'livecodingphp16.jpg',
            'description' => 'Découvre comment créer un site de A à Z en PHP : la mise en place de services',
            'category' => Video::CATEGORY_LIVECODING,
        ],
        [   'video' => 'phplivecoding.mp4',
            'title' => 'Développer un site de recettes en PHP avec Symfony (17/19)',
            'thumbnail' => 'livecodingphp17.jpg',
            'description' => 'Découvre comment créer un site de A à Z en PHP : système d\'administration avec EasyAdmin',
            'category' => Video::CATEGORY_LIVECODING,
        ],
        [   'video' => 'phplivecoding.mp4',
            'title' => 'Développer un site de recettes en PHP avec Symfony (18/19)',
            'thumbnail' => 'livecodingphp18.jpg',
            'description' => 'Découvre comment créer un site de A à Z en PHP : mise en place des tests',
            'category' => Video::CATEGORY_LIVECODING,
        ],
        [   'video' => 'phplivecoding.mp4',
            'title' => 'Développer un site de recettes en PHP avec Symfony (19/19)',
            'thumbnail' => 'livecodingphp19.jpg',
            'description' => 'Découvre comment créer un site de A à Z en PHP : Webpack Encore, JavaScript et CSS',
            'category' => Video::CATEGORY_LIVECODING,
        ],
    ];
    ...
    public const VIDEO_CSS_LESSON_DATA = [
        ...
        [   'video' => 'csslesson.mp4',
            ...
            'description' => 'Découvre comment manipuler les modèles de boîte en CSS pour styliser ta page',
            'category' => Video::CATEGORY_LESSON,
        ],
        [   'video' => 'csslesson.mp4',
            'title' => 'Les polices',
    ...
    public const VIDEO_CSS_TUTORIEL_DATA = [
        [   'video' => 'csstutoriel.mp4',
            ...
            'description' => 'Découvre comment mettre en place un effet de parallaxe en CSS pour styliser ta page',
            'category' => Video::CATEGORY_TUTORIEL,
        ],
        [   'video' => 'csstutoriel.mp4',
            'title' => 'Créer une zoombox',
            'thumbnail' => 'zoomboxcss.jpg',
            'description' => 'Découvre comment mettre en place un effet de zoombox en CSS pour styliser ta page',
            'category' => Video::CATEGORY_TUTORIEL,
        ],
        [   'video' => 'csstutoriel.mp4',
    ...
    public const VIDEO_CSS_LIVECODING_DATA = [
        [   'video' => 'csslivecoding.mp4',
            ...
            'description' => 'Découvre comment créer un site web responsive à partir de rien : créer une barre de navigation',
            'category' => Video::CATEGORY_LIVECODING,
        ],
        [   'video' => 'csslivecoding.mp4',
            'title' => 'Création d\'un site web responsive à partir de rien (2/7)',
            'thumbnail' => 'livecodingcss2.jpg',
            'description' => 'Découvre comment créer un site web responsive à partir de rien : créer un menu hamburger animé',
            'category' => Video::CATEGORY_LIVECODING,
        ],
        [   'video' => 'csslivecoding.mp4',
            'title' => 'Création d\'un site web responsive à partir de rien (3/7)',
            'thumbnail' => 'livecodingcss3.jpg',
            'description' => 'Découvre comment créer un site web responsive à partir de rien : créer un menu mobile animé',
            'category' => Video::CATEGORY_LIVECODING,
        ],
        [   'video' => 'csslivecoding.mp4',
            'title' => 'Création d\'un site web responsive à partir de rien (4/7)',
            'thumbnail' => 'livecodingcss4.jpg',
            'description' => 'Découvre comment créer un site web responsive à partir de rien : rendre la page principale responsive',
            'category' => Video::CATEGORY_LIVECODING,
        ],
        [   'video' => 'csslivecoding.mp4',
            'title' => 'Création d\'un site web responsive à partir de rien (5/7)',
            'thumbnail' => 'livecodingcss5.jpg',
            'description' => 'Découvre comment créer un site web responsive à partir de rien : utiliser les flexbox pour construire un layout responsive',
            'category' => Video::CATEGORY_LIVECODING,
        ],
        [   'video' => 'csslivecoding.mp4',
            'title' => 'Création d\'un site web responsive à partir de rien (6/7)',
            'thumbnail' => 'livecodingcss6.jpg',
            'description' => 'Découvre comment créer un site web responsive à partir de rien : utiliser les grid pour construire un layout responsive',
            'category' => Video::CATEGORY_LIVECODING,
        ],
        [   'video' => 'csslivecoding.mp4',
            'title' => 'Création d\'un site web responsive à partir de rien (7/7)',
            'thumbnail' => 'livecodingcss7.jpg',
            'description' => 'Découvre comment créer un site web responsive à partir de rien : créer un footer',
            'category' => Video::CATEGORY_LIVECODING,
        ],
    ];
