...
class VideoFixtures extends Fixture implements DependentFixtureInterface
{
    public function load(ObjectManager $manager): void
    {
        ...
        $firstLesson  ->setTitle("Apprendre #Symfony 6 - Installation et configuration")
                ->setThumbnail("https://www.dzfoot.com/wp-content/uploads/2022/07/AG-%C2%AClective-de-la-FAF-16-750x430-600x390.jpg")
        ...
        $secondLesson  ->setTitle("Apprendre #Symfony 6 - Notre première page")
                ->setThumbnail("https://cdn.lebuteur.com/data/images/article/thumbs/large-zefzef-a-fait-une-viree-au-stade-hier-a6ab8.jpg")
        ...
        $fifthLesson  ->setTitle("Apprendre #Symfony 6 - Validation des entités")
                ->setThumbnail("https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSQ3qza-vLatZLZ1J6jGHmxLNTqjbQeTcuNKw&usqp=CAU")
