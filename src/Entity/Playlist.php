...
class Playlist
{
    ...
    #[Assert\Length(
        max: 255,
        maxMessage: 'Le nom de la playlist : {{ value }} est trop long, il ne peut pas dépasser {{ limit }} caractères',
    )]
    #[Assert\NotBlank(message: 'Un nom de playlist est obligatoire')]
